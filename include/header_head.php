...
<?php
  ...
  $systemtime = date('Y-m-d H:i:s');
	...
	if($access!='3'){
		$systemlog = "INSERT INTO system_log (action, date_created, user) VALUES ('Tries to access head account.', '$systemtime', '$username')";
...
?>
	<head>
		...
		<?php
			$con->next_result();
			$query = mysqli_query($con, "SELECT * FROM accounts JOIN section ON section.sec_id=accounts.sec_id JOIN department ON department.dept_id=section.dept_id WHERE username='$username' ");
	...
	<nav class="navbar navbar-default navbar-static-top" role="navigation">
		<div class="navbar-header">
			<button type="button" id="sidebarCollapse" class="pull-left" style="border: none; margin-top: -5px;">
			...
			<ul class="nav" id="side-menu">
				...
				<li>
					...
					<ul class="nav nav-second-level">
						...
						<li>
							<a href="list_tasks_details.php"><i class="fa fa-archive fa-fw"></i> Task Details</a>
						</li>
					</ul>
				</li>
				<li>
					<a href="staff_performance.php"><i class="fas fa-trophy fa-fw"></i> Staff Performance</a>
				</li>
				<li>
