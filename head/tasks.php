	...
	<div id="content" class="p-4 p-md-5 pt-5">
		<div id="wrapper">
			<div id="page-wrapper">
				...
				<form method="POST" action="../admin/sortdl.php?status=<?php echo $status."&dept_id=".$dept_id ?>">
					<div class="row">
						...
						<button id="submit" class="btn btn-success pull-left" style="margin-top: 25px; display: none;"><i class="fa fa-download"></i> Download XLS</button>
						<a href="tasks_xls.php?status=<?php echo $status."&dept_id=".$dept_id ?>" id="btn1"> <span class="btn btn-success pull-left" style="margin-top: 25px;"> <i class="fa fa-download"></i> Download XLS</span></a>
					</div>
				</form>
				<div class="row">
					<div class="col-lg-12">
	...
	<script>
		function selectfrom(element) {
		    ...
		    let status = <?php echo json_encode($status) ?>;
				let dept_id = <?php echo json_encode($dept_id) ?>;
