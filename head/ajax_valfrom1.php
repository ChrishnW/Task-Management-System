...
if(isset($_POST['valfrom'])){
    ...
    if($val_to != 0){
        ...
        WHERE tasks_details.task_status IS TRUE AND tasks_details.approval_status = 0  AND tasks_details.reschedule = 2 AND tasks_details.due_date >='$val_from' AND tasks_details.due_date <='$val_to' AND tasks_details.status='NOT YET STARTED'");               
