<?php 
    ...
    $sql = mysqli_query($con, "SELECT * from accounts WHERE username='$id'");
...
<div id="content" class="p-4 p-md-5 pt-5">
    <div id="wrapper">
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Employee Assigned Tasks
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <a href="regtask.php?in_charge=<?php echo $id ?>"> <button class='btn btn-success pull-right'><i class="fa fa-plus fa-fw"></i> Assign Additional Task</button></a>
                                <br><br><br>
