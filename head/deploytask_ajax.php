...
if(isset($_POST['sid'])){
  $username = $_POST['sid'];
  $con->next_result();
  $query = "SELECT tasks.task_code, task_list.task_name FROM tasks LEFT JOIN task_list ON task_list.task_code=tasks.task_code WHERE tasks.in_charge='$username' GROUP BY task_list.task_name ORDER BY task_list.task_name ASC";
