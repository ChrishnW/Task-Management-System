...
<div id="content" class="p-4 p-md-5 pt-5">
    <div id="wrapper">
        <div id="page-wrapper">
        <h1 class="page-header"><?php echo $section ?> Staff Performace </h1>
        <form method="POST" action="performance_report.php?section=<?php echo $section ?>">
