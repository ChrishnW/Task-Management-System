...
<body>
    <div id="wrapper">
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Deploy Task</h1>
                </div>
            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <form data-toggle="validator" class="className" name="form" id="form"
                                        action="deploytask_submit.php" method="POST">
                                        <div class="form-group">
                                            <div class="form-group required">
                                                ...
                                                <select name="emp_name" id="emp_name" required
                                                    ...
                                                    <?php
                                                        $sql = mysqli_query($con,"SELECT * FROM accounts WHERE access='2' ORDER BY accounts.sec_id ASC"); 
                                                        $con->next_result();
