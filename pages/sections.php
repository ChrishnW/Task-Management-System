            ...
            <tbody>
              ...
              if (mysqli_num_rows($result) > 0) {
                while ($row = $result->fetch_assoc()) {
                  ...
                  ?>
                  <tr>
                    <td><button type="button" class="btn btn-info btn-circle" onclick="editSection(this)" value="<?php echo $row['id'] ?>" data-id="<?php echo $row['sec_id']?>" data-name="<?php echo $row['sec_name'] ?>" data-status="<?php echo $row['status']?>" data-department="<?php echo $row['dept_id']?>"><i class="fas fa-pen"></i></button> <button type="button" onclick="deleteSectionView(this)" class="btn btn-danger btn-circle" value="<?php echo $row['id'] ?>" data-section="<?php echo $row['sec_id'] ?>"><i class="fas fa-trash"></i></button></td>
