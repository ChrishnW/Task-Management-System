              ...
              <div class="card-body">
                <div class="row no-gutters align-items-center">
                  <div class="col">
                    ...
                    <div class="h6 mb-1 font-weight-bold text-gray-800">22 Tasks Assigned</div>
                    <div class="text-xs text-muted mb-2">4 due today</div>
                    <div class="progress mb-3">
                      <div class="progress-bar bg-primary" role="progressbar" style="width: 60%" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                    <div class="text-xs text-muted">Completed: 13 / 22</div>
                    <div class="mt-3">
              ...
              <div class="card-body">
                ...
                <div class="row no-gutters align-items-center">
                  <div class="col">
                    ...
                    <div class="h6 mb-1 font-weight-bold text-gray-800">4 Ongoing Projects</div>
                    <div class="text-xs text-muted mb-2">1 deadline this week</div>
                    <div class="progress mb-3">
                      <div class="progress-bar bg-info" role="progressbar" style="width: 75%" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                    <div class="text-xs text-muted">Completed: 3 / 4</div>
                    <div class="row mt-3">
                      <div class="col text-center">
                        <div class="text-xs font-weight-bold text-info text-uppercase">Active</div>
                        <div class="h5 mb-0 font-weight-bold text-gray-800">2</div>
                      </div>
                      <div class="col text-center">
                        <div class="text-xs font-weight-bold text-info text-uppercase">Completed</div>
                        <div class="h5 mb-0 font-weight-bold text-gray-800">1</div>
                      </div>
                      <div class="col text-center">
                        <div class="text-xs font-weight-bold text-info text-uppercase">Upcoming</div>
                        <div class="h5 mb-0 font-weight-bold text-gray-800">1</div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="card-body">
                <div class="row no-gutters align-items-center">
                  <div class="col">
                    ...
                    <div class="h6 mb-1 font-weight-bold text-gray-800">120 Files Uploaded</div>
                    <div class="text-xs text-muted mb-2">12 uploaded this week</div>
                    <div class="progress mb-3">
                      <div class="progress-bar bg-warning" role="progressbar" style="width: 85%" aria-valuenow="85" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                    <div class="text-xs text-muted">Storage used: 85%</div>
                    <div class="row mt-3">
                      <div class="col text-center">
                        <div class="text-xs font-weight-bold text-warning text-uppercase">Documents</div>
                        <div class="h5 mb-0 font-weight-bold text-gray-800">75</div>
                      </div>
                      <div class="col text-center">
                        <div class="text-xs font-weight-bold text-warning text-uppercase">Images</div>
                        <div class="h5 mb-0 font-weight-bold text-gray-800">35</div>
                      </div>
                      <div class="col text-center">
                        <div class="text-xs font-weight-bold text-warning text-uppercase">Other</div>
                ...
                <div class="row no-gutters align-items-center">
                  <div class="col">
                    <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                      Member's Monthly Performance
                    </div>
                    <div class="h5 mb-2 font-weight-bold text-gray-800">October 2024</div>

                    <!-- Total Average -->
                    <div class="text-xs font-weight-bold text-uppercase mb-1">
                      Total Average: <span class="text-gray-800">87%</span>
                    </div>
                    ...
                    <div class="mt-3">
                      ...
                      <div class="text-xs text-muted">Completed: 17 / 20 tasks</div>
                    </div>
                  </div>
                </div>
              </div>
