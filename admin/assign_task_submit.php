...
if($checkrows>0) {
    ...
    $sql = "INSERT INTO tasks_details (task_code, date_created, due_date, in_charge, status, task_status) VALUES (:task_code, :date_created, :due_date, :in_charge, :status, :task_status)";
