                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <form data-toggle="validator" class="className" name="form" id="form"
                                        action="task_add_submit.php" method="POST">
                                        <div class="form-group">
                                            ...
                                            <div class="form-group required">
                                                ...
                                                <input type="text" placeholder="Enter Task Name" class="form-control"
                                                    name="task_name" id="task_name" style="text-transform:uppercase"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" placeholder="Enter Task Details" class="form-control"
                                                    name="task_details" id="task_details" style="text-transform:uppercase"
