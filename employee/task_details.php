...
<div id="content" class="p-4 p-md-5 pt-5">
	<div id="wrapper">
		<div id="page-wrapper">
			<h1 class="page-header"><?php echo $status_name ?> <font style="color:red;">Tasks</font>
			</h1>
			<div class="row">
...
<script>
	function replace_attachment(obj) {
		var replace_inputcode = document.getElementById('taskcode2').value;
		// var replace_fileinput = document.getElementById('file2').value;

		$(document).ready(function() {
			$('#edit_2').modal('show');
			document.getElementById('replace_track').value = replace_inputcode;
			// document.getElementById('replace_myH1').innerHTML = replace_inputcode;
		});
	}
	...
	function okButtonClick_4() {
		var replaceID = document.getElementById('replace_track').value;
		var replaceFile = document.getElementById('fileInput2');
		var btn = document.getElementById('saveedit2');
		...
		$.ajax({
			type: "POST",
			url: "task_details_replace_attachment.php",
			data: formData,
			contentType: false,
			processData: false,
		}).done(function(response) {
			document.getElementById('saveedit2').disabled = true;
...
<div class="modal fade" id="finish_1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" aria-hidden="true">
	<div class="modal-dialog modal-lg" <div class="modal-content panel-success">
		<div class="modal-header panel-heading">
...
<div class="modal fade" id="view2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content panel-success">
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-success pull-left" data-dismiss="modal" onclick='edit_task1()'><span class="fa fa-pencil-square-o fa-fw"></span> Edit Remarks</button>
				<button type="button" id="attch_rep" class="btn btn-warning pull-left px-3" data-dismiss="modal" onclick='replace_attachment()'><i class="fas fa-unlink fa-fw"></i> Replace Attachment</button>
...
<div class="modal fade" id="edit_2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content panel-success">
			<div class="modal-header panel-heading">
				<a href="#" onclick="goBackAndReload()"><button type="button" class="close">&times;</button></a>
			...
			<div class="modal-body panel-body">
				<center>
					<input type="text" id="replace_track" name="replace_track" hidden>
					<p>Select your file attachment.</p>
					<input type="file" class="form-control" id="fileInput2" accept=".pdf, .docx, .xls, .xlsx, .pptx, .txt" />
					<br>
				</center>
			</div>
			<div class="modal-footer">
				<button id='saveedit2' class='btn btn-success pull-left' onclick="okButtonClick_4()"><i class='fa fa-floppy-o fa-1x'></i> Save</button>
				<a href="#" onclick="goBackAndReload()"><button type="button" class="btn btn-danger pull-right"><span class="fa fa-times"></span> Close</button></a>
			</div>
		</div>
	</div>
