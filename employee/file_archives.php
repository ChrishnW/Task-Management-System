					...
					<div class="col-lg-12">
                      ...
                      if (mysqli_num_rows($query) > 0){
                        ...
                        <tr>
                          ...
                          <td><button type="button" class="btn btn-info" value="<?php echo $row['task_code']?>" data-link="<?php echo $row['attachment'];?>" onclick="viewPDF(this)"><i class="fas fa-book-reader fa-fw"></i> View</button></td>
                        </tr>
                        <?php }
                      }
                      ?>
